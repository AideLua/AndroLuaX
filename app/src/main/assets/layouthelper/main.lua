...
wds={
  ...
  {"AppBarLayout","CollapsingToolbarLayout",
    ...
    "CircularRevealGridLayout","FloatingActionButton","NavigationView","TabLayout","TextInputEditText",
   "TextInputLayout","SwitchMaterial","MaterialSwitch"},
}
